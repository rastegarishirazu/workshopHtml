...
var dashboard = new Vue({
    ...
    beforeMount : function(){
        var id
        axios.get('http://registerhere.ir/dapi/api/v1/users/token',{
            headers: {
...
function getUser(id){
    axios.get('http://registerhere.ir/dapi/api/v1/users/'+id,{
        headers: {
            'Content-type': 'application/json',
            'Authorization': document.cookie
    }}).then( function (response) {
...
function getUserRole(id){
    axios.get('http://registerhere.ir/dapi/api/v1/users/'+id+'/roles',{
        headers: {
            'Content-type': 'application/json',
            'Authorization': document.cookie
